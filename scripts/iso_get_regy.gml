...
switch(iso_projection)
{
    ...
    // South East
    case ipro_se: return -(argument1)/iso_factor+room_height/2+argument0;
    // South West
    case ipro_sw: return -(argument1)/iso_factor+room_height-argument0+room_width/2;
    // North West
